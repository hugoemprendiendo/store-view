...
let incidents: Incident[] = [
  ...
  { id: '105', title: 'Temperatura del congelador demasiado alta', branchId: '4', category: 'Seguridad Alimentaria', priority: 'Medium', status: 'Abierto', createdAt: '2024-05-22T18:45:00Z', description: 'La temperatura del congelador walk-in marca -5°C en lugar de los -18°C requeridos.' },
  ...
  { id: '107', title: 'La pantalla de pedidos del drive-thru está en blanco', branchId: '2', category: 'Drive-Thru', priority: 'Medium', status: 'Abierto', createdAt: '2024-05-23T08:00:00Z', description: 'La pantalla de confirmación de pedidos digital en el drive-thru no muestra nada.'}
];
